...
//用户程序Flash偏移
uint32_t FlashDestination = AppAddress;
                ...
                default:
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            for (j = 0; (j < packet_length) && (FlashDestination <  AppAddress + size); j += 4)
                            {
                                //把接收到的数据编写到Flash中
...
uint8_t Ymodem_Transmit (uint8_t *buf, const uint8_t* sendFileName, uint32_t sizeFile)
{
    ...
    return 0;//transmition successful
}
